...
def main() -> int:
    print("🚀 Starting unscript publish process...")
    ...
    run(["gh", "release", "create", tag, "--title", f"unscript v{version}", "--notes-file", notes_path])

    print("🎉 unscript publish process completed successfully!")
